      ...
      (function () {
        ...
        var a = function (e, t) {
          ...
          for (; (r = e.search(a)), -1 !== r; ) {
            r > 0 &&
              (o.push({ type: "text", data: e.slice(0, r) }), (e = e.slice(r)));
          ...
          return "" !== e && o.push({ type: "text", data: e }), o;
        };
        const l = function (e, n) {
            ...
            for (let e = 0; e < r.length; e++)
              if ("text" === r[e].type)
                o.appendChild(document.createTextNode(r[e].data));
              else {
                ...
                try {
                  ...
                  n.errorCallback(
                    ...
                    o.appendChild(document.createTextNode(r[e].rawData));
                  continue;
                }
                o.appendChild(i);
              }
            ...
            for (let n = 0; n < e.childNodes.length; n++) {
              ...
              if (3 === r.nodeType) {
                ...
                for (; i && i.nodeType === Node.TEXT_NODE; )
                  (o += i.textContent), (i = i.nextSibling), a++;
                const s = l(o, t);
                if (s) {
                ...
                const e = " " + r.className + " ";
                -1 === t.ignoredTags.indexOf(r.nodeName.toLowerCase()) &&
                  t.ignoredClasses.every(
                    (t) => -1 === e.indexOf(" " + t + " "),
                  ) &&
                  s(r, t);
              }
